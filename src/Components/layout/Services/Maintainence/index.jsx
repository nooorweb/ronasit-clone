        ...
        <div className="mt-10 md:mt-32 max-w-2xl  flex flex-col gap-20 ">
          ...
          >
            <div className=" group flex flex-col gap-12  md:pb-40     p-5 lg:max-w-80 relative ">
              ...
              <p className="text-sm">
                As a software development company, we help to keep projects
                up-to -date – from technology updates to new functionality
                implementation.
              </p>
            </div>
            <div className=" group flex flex-col gap-6  md:pb-40    p-5 lg:max-w-80  relative">
              ...
              <p className="text-sm">
                Keeping your project up and running 24/7/365 is important. We
                make this process easy and stress-free for you.
              </p>
            </div>
          </div>
        </div>
