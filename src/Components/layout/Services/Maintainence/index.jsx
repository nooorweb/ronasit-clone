...
const Maintain = () => {
  ...
  return (
    <div className="flex flex-col mt-20  lg:gap-32 justify-between py-15 lg:flex-row" data-aos="fade-up">
      ...
      <div className="mt-10 md:mt-32 max-w-2xl  flex flex-col gap-20 " >
        <div className=" flex flex-col gap-10 lg:px-8 md:w-fit  ">
          <p className="text-xl md:text-2xl">
            ...
            way to make them user-oriented and up-to-date. Through such a
        ...
        <div className=" flex md:mb-28  gap-12 lg:gap-0 flex-col lg:flex-row" data-aos="fade-up">
          <div className=" group flex flex-col gap-12  md:pb-40     p-5 lg:max-w-80 relative ">
            ...
            <p className="text-sm">
              As a software development company, we help to keep projects up-to
              -date – from technology updates to new functionality
              implementation.
            </p>
          </div>
          <div className=" group flex flex-col gap-6  md:pb-40    p-5 lg:max-w-80  relative">
            ...
            <p className="text-sm">
              Keeping your project up and running 24/7/365 is important. We make
              this process easy and stress-free for you.
            </p>
          </div>
        </div> 
      </div>
