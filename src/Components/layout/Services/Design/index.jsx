...
const Design = () => {
  ...
  return (
    <div className="flex justify-between py-15 flex-col md:flex-row" data-aos="fade-up">
      <div className="flex flex-col gap-10"  >
        <p>01</p>
        <h2 className=" text-services-size md:text-5xl font-medium">Design</h2>
      </div>
      ...
      <div className=" mt-10   md:mt-32 max-w-2xl bg-gre flex flex-col gap-20">
        ...
        <div className="grid grid-cols-1 grid-rows-4 gap-6 md:grid-cols-2 md:grid-rows-2 md:gap-0"  data-aos="fade-up">
