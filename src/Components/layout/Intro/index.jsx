...
const Intro = () => {
  ...
  return (
<div className="flex flex-col  lg:flex-row   mt-16  justify-between  gap-1" data-aos="fade-up">
      ...
      <div className="flex flex-col gap-7 items-start  lg:px-10">
        ...
        <h1 className="text-4xl  font-semibold leading-1 lg:leading-normal ">
         ...
         <button className='py-5 px-10   text-black rounded-full border-2 border-slate-400 bg-white hover:text-white  hidden lg:block'>View More</button> 
      </div>
      <div className="flex flex-col gap-4 pt-8 lg:pt-14">
        ...
        <button className='py-5 px-10  mt-4 text-black rounded-full border-2 border-slate-400 bg-white hover:text-white  w-fit   lg:hidden'>View More</button> 
      </div>
    </div>
  );
};
