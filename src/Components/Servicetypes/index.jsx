    ...
    <>
      <div className="flex   justify-between pt-20 pb-20  px-7"  >
        ...
        <div className="flex    flex-col gap-8 justify-between  w-9/12 ">
          <div className="flex gap-12     justify-between items-start "  data-aos='fade-up'>
          ...
          <div className="flex    gap-12   text-left   justify-between items-start pt-4"  data-aos='fade-up'>
